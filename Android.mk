...
LINEAGE_SRC_API_DIR := $(TOPDIR)vendor/custom/api
...
FRAMEWORK_LINEAGE_API_NEEDS_UPDATE_TEXT := $(TOPDIR)vendor/custom/build/core/apicheck_msg_current.txt
...
LOCAL_DROIDDOC_CUSTOM_TEMPLATE_DIR := vendor/custom/build/tools/droiddoc/templates-lineage-sdk
